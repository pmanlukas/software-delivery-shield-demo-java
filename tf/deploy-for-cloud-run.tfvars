...
## NOTE! You MUST provide either an existing Project ID or a Google Cloud Billing account number, below. 
## You do not need both (but it won't hurt if you do include both)
...
# google_billing_account = "00000-000000-0000"